    ...
    <div className="w-[400px] h-[240px] sm:h-[500px] bg-black/80 backdrop-blur-lg rounded-full flex items-center justify-center p-6">
      <div className="text-left">
        <h1 className="text-white text-4xl font-bold mb-4">
          Innovate, Build, and Grow with Tech Nexus
        </h1>
        <p className="intro-p text-lg md:text-[17px] w-full text-gray-300 mb-8">
          Discover products, downloads,<br />
          and services in one place.
        </p>
        <Link
          href="/store/services"
          className="intro-btn inline-block bg-black/50 hover:bg-black/70 text-white font-semibold py-2 px-3 rounded-lg transition-colors duration-200 text-sm shadow-lg shadow-purple-500/50 border border-purple-500/30"
        >
